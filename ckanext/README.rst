...
To install this package, from your CKAN virtualenv, run the following from your CKAN base folder (e.g. ``pyenv/``)::
  ...
  pip install -e git+https://github.com/Cadasta/ckanext-cadasta

  python setup.py develop

Then activate it by setting ``ckan.plugins = cadasta`` in your main ``ini``-file.

Orientation
===========

* Examine the source code, starting with ``ckanext/cadasta/plugin.py``
